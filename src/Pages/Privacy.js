	...
	render(){
		...
		return (
			<main>
				...
				<p>For a better experience, while using our Service, we collect information your device sends such as your internet protocol (IP) address. The IP address does not identify you personally, but it allows us to maintain communications with you as you move about the Website. Generally, these types of data elements do not reveal your identity or do not relate directly to you or any other individual.</p>
				...
				<p>Any information collected is not analyzed under normal circumstances, the only time the information collected is analyzed is when there is a technical issue with accessing our service.</p> 
